 ...
 * node: 22
 * [@chubbyts/chubbyts-decode-encode][2]: ^2.2.0
 * [@chubbyts/chubbyts-http-error][3]: ^3.2.0
 * [@chubbyts/chubbyts-log-types][4]: ^3.1.0
 * [@chubbyts/chubbyts-negotiation][5]: ^4.1.0
 * [@chubbyts/chubbyts-throwable-to-error][6]: ^2.1.0
 * [@chubbyts/chubbyts-undici-server][7]: ^1.1.1
 * [qs][8]: ^6.15.1
 * [uuid][9]: ^13.0.0
 * [zod][10]: ^4.3.6
...
```ts
npm i @chubbyts/chubbyts-undici-api@^1.3.0
```
